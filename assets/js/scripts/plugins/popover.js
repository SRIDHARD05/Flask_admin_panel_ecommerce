class Popover {
    ...
    hidePopover() {
        // TODO: Solve the Error to hide the Popovers

        // if (this.popover) {
        //     // Remove the specified classes only if the popover exists
        //     this.popover.classList.remove('popover', 'interactive-popover');

        //     // Optionally remove all child elements if necessary
        //     while (this.popover.firstChild) {
        //         this.popover.removeChild(this.popover.firstChild); // Removes all children one by one
        //     }

        //     console.log("Popover hidden and children removed.");
        // } else {
...
// TODO: Do Uglify and Minifications Works